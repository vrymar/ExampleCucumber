...
cucumber_1.Given(/^accept all cookies$/, () => __awaiter(void 0, void 0, void 0, function* () {
    if ((yield suitest_js_api_1.default.element(getSelector('FunctionalCookiesBtn')).visible().timeout(1000))
        && (yield suitest_js_api_1.default.element(getSelector('ScrollBarCookie')).visible().timeout(1000))) {
    ...
    if (yield suitest_js_api_1.default.element(getSelector('AllCookiesAccepteren')).visible().timeout(1000)) {
...
cucumber_1.When(/^login is successful with email '(.*)' and password '(.*)'$/, (email, password) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield suitest_js_api_1.assert.element(getSelector('LoginField')).exists().timeout(100).then(() => __awaiter(void 0, void 0, void 0, function* () { yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.DOWN); }));
    ...
    yield suitest_js_api_1.assert.element(getSelector('backBtnKlantenService')).exists().timeout(1000).then(() => __awaiter(void 0, void 0, void 0, function* () { yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.BACK); }));
    yield suitest_js_api_1.assert.element(getSelector('LoginField')).exists().then(() => __awaiter(void 0, void 0, void 0, function* () {
        yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.DOWN);
        yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.ENTER);
    }));
    yield suitest_js_api_1.assert.element(getSelector('emailInput')).exists().timeout(1000);
    yield suitest_js_api_1.assert.element(getSelector('emailInput')).setText(email).then(() => __awaiter(void 0, void 0, void 0, function* () {
        yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.RIGHT).repeat(12).interval(10);
        yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.DOWN).repeat(1).interval(10);
        yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.ENTER);
    }));
...
cucumber_1.Then(/^profile page is accessed and displayed correctly$/, () => __awaiter(void 0, void 0, void 0, function* () {
    yield suitest_js_api_1.assert.element(getSelector('firstProfi')).exists().timeout(1000).then(() => __awaiter(void 0, void 0, void 0, function* () { yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.LEFT).repeat(5).interval(100); }));
    yield suitest_js_api_1.assert.element(getSelector('firstProfi')).exists().then(() => __awaiter(void 0, void 0, void 0, function* () { yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.ENTER); }));
...
cucumber_1.Then(/^GeoBlock is accessed and displayed correctly$/, () => __awaiter(void 0, void 0, void 0, function* () {
    yield suitest_js_api_1.assert.element(getSelector('GeoBlock')).exists().timeout(100).then(() => __awaiter(void 0, void 0, void 0, function* () { yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.RIGHT); }));
    yield suitest_js_api_1.assert.element(getSelector('LogOutButton')).exists().timeout(100).then(() => __awaiter(void 0, void 0, void 0, function* () { yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.ENTER).repeat(2).interval(10); }));
...
cucumber_1.Then(/^Home Screen is accessed and displayed correctly$/, () => __awaiter(void 0, void 0, void 0, function* () {
    yield suitest_js_api_1.assert.element(getSelector('VLLogo')).exists().timeout(100);
}));
cucumber_1.Then(/^video is played and navigated$/, () => __awaiter(void 0, void 0, void 0, function* () {
    if (yield suitest_js_api_1.default.element(getSelector('VLLogo')).exists().timeout(100)) {
        yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.DOWN);
        yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.DOWN);
...
cucumber_1.Then(/^logout is successful$/, () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield suitest_js_api_1.assert.element(getSelector('firstProfi')).exists().timeout(8000).then(() => __awaiter(void 0, void 0, void 0, function* () {
        yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.DOWN);
        yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.ENTER);
        yield suitest_js_api_1.assert.press(suitest_js_api_1.VRC.ENTER);
    }));
