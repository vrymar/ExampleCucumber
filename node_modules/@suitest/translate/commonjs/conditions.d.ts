...
import { Condition, AppConfiguration, Elements } from '@suitest/types';
/**
 ...
 */
export declare const translateCondition: (condition: Condition, appConfig: AppConfiguration, elements?: Elements | undefined) => ConditionNode;
